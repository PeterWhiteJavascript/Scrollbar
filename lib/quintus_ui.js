...
Quintus.UI = function(Q) {
  ...
  Q.UI.Container = Q.Sprite.extend("UI.Container", {
    init: function(p,defaults) {
      ...
      this._super(Q._defaults(adjustedP,defaults),{
        ...
        shadow: 3, // Set to true or a shadow offest
  ...
  Q.UI.Button = Q.UI.Container.extend("UI.Button", {
    ...
    */
    setFont: function(ctx) {
      ...
      ctx.font = this.p.font || "400 16px arial";
      ctx.fillStyle = this.p.fontColor || "white";
  ...
  Q.UI.HTMLElement = Q.Sprite.extend("UI.HTMLElement", {
    init: function(p) {
      ...
      this.el = document.createElement(""+this.p.htmlElm);
      this.el.innerHTML = this.p.html;
      this.el.style.overflow="scroll";
      if(this.p.htmlElm==="a"){
          this.el.href = this.p.href;
      }
      if(this.p.htmlPos){
          this.el.style.position=this.p.htmlPos;
      }
      if(this.p.htmlId){
          this.el.id=this.p.htmlId;
      }
