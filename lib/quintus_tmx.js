...
Quintus.TMX = function(Q) {
 ...
 Q._tmxProcessTileLayer = function(stage,gidMap,tileProperties,layer) {
   ...
   if(tileLayerProperties['collision']||tileLayerProperties['water']) {
     if(tileLayerProperties.water){tileLayerProperties.opacity=0.7;}else{tileLayerProperties.opacity=1};
